...
build:	clean
	DOCKER_BUILDKIT=$(DOCKER_BUILDKIT) $(DOCKER) build \
		...
		. --file docker/Dockerfile --tag public.ecr.aws/unocha/assessmentregistry8-site:local \
		2>&1 | tee buildlog.txt
	@echo "Built a shiny new public.ecr.aws/unocha/assessmentregistry8-site:local for you."
